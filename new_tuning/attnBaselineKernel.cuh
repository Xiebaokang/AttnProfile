...
template<
    ...
    int NUM_THREADS=384
>
void runAttnWSBaselineKernel(fp16 *Q, fp16 *K, fp16 *V, fp16 *O) {
    ...
    auto* kernel = attnWSBaselineKernel<BM, BN, D, NUM_THREADS, NUM_SMEM, PRODUCER_REG_DEALLOC, CONSUMER_REG_ALLOC>;
